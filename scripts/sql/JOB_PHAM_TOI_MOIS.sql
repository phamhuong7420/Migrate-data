...
INSERT INTO "QLPN"."PHAM_TOI_MOIS"
  ...
  /*+ USE_HASH(B C) */
   ...
   NULL, -- DELETION_TIME
   DT.ID, -- DM_TOI_DANH (Lưu mã cũ vào cột text) D.TD_TEN
   ...
   INNER JOIN "QLPN"."DM_TOI_DANHS" D
      ON A.MA_TOI_DANH_PTM = D.TD_MA
   INNER JOIN "QLPN"."DM_TOI_DANHS" DT
      ON A.MA_TOI_DANH_PTM = DT.TD_MA;