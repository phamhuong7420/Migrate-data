...
INSERT INTO "QLPN"."PN_DAC_XAS"
  ...
  SELECT
   ...
   DTG.MTG_TITLE  MA_MUC_TG_CHAP_HANH_DX, -- DX_THOI_GIAN_GIAM
   ...
   '[' ||A.MA_DUOC_DAC_XA || ']' MA_DUOC_DAC_XA, -- DX_TINH_TRANG_DAC_XA
   ...
   INNER JOIN "QLPN"."PN_LAI_LICHS" C
    ...
    LEFT JOIN "QLPN"."DM_DUOC_DAC_XAS" DDDX
      ...
      ON DDDX.DDX_MA = A.MA_DUOC_DAC_XA

      LEFT JOIN QLPN.DM_MA_THOI_GIANS DTG ON DTG.MTG_MA = A.MA_MUC_TG_CHAP_HANH_DX

      LEFT JOIN QLPN.DM_DUOC_DAC_XAS DDX ON DDX.DDX_MA = A.MA_DUOC_DAC_XA;